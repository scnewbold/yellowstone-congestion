...
if(TRUE){
  ...
  if(TRUE){
    tikz(paste(output.path,'/sim-histograms-fullyear.tex',sep=''),
         width      = 6.5,
         height     = 6.5,
         pointsize  = 12,
         standAlone = TRUE)
...
if(TRUE){
  ...
  # pdf figure: simulation histograms
  if(TRUE){
    tikz(paste(output.path,'/sim-histograms-mayoct.tex',sep=''),
         width      = 6.5,
         height     = 6.5,
         pointsize  = 12,
         standAlone = TRUE)
...
if(TRUE){
  ...
  if(TRUE){
    ...
    tikz(paste(output.path,'/cv-vs-y.tex',sep=''),
         width      = 4.5,
         height     = 4.5,
         pointsize  = 12,
         standAlone = TRUE)
  ...
  # CONGESTION ESTIMATION:
  {
    ...
    # pdf figure:
    {
      tikz(paste(output.path,'/congestion-peak.tex',sep=''),
           width      = 5.5,
           height     = 5.5,
           pointsize  = 12,
           standAlone = TRUE)
  ...
  if(TRUE){
    ...
    {
      tikz(paste(output.path,'/bootstrap-histogram.tex',sep=''),
           width      = 6.5,
           height     = 6.5,
           pointsize  = 12,
           standAlone = TRUE)
  ...
  for(transform in c('none','linear','exponential')){
    ...
    { 
      ...
      # pdf figure:
      {
        tikz(paste(output.path,'/lny-vs-c-',transform,'.tex',sep=''),
             width      = 4.5,
             height     = 2.5,
             pointsize  = 12,
             standAlone = TRUE)
    ...
    if(TRUE){
      ...
      {
        tikz(paste(output.path,'/monthly-fees-',transform,'.tex',sep=''),
             width      = 3.5,
             height     = 3.5,
             pointsize  = 12,
             standAlone = TRUE)
  ...
  if(TRUE){
    ...
    {
      tikz(paste(output.path,'/tau-vs-theta.tex',sep=''),
           width      = 5.5,
           height     = 5.5,
           pointsize  = 12,
           standAlone = TRUE)
  ...
  if(TRUE){
    ...
    tikz(paste(output.path,'/surplus-vs-tau.tex',sep=''),
         width      = 5.5,
         height     = 5.5,
         pointsize  = 12,
         standAlone = TRUE)
  ...
  if(TRUE){
    ...
    # pdf figure: Yseries
    {
      ...
      tikz(paste(output.path,'/Yseries.tex',sep=''),
           width      = 5.5,
           height     = 3.5,
           pointsize  = 12,
           standAlone = TRUE)
    ...
    # pdf figure: Yratio
    {
      tikz(paste(output.path,'/Yratio.tex',sep=''),
           width      = 5.5,
           height     = 3.5,
           pointsize  = 12,
           standAlone = TRUE)
